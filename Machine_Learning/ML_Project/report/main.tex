...
This will create an equation with the formula $E = mc^2$ and a number on the right-hand side. The \verb+\label+ command is used to assign a name to the equation, which can be referenced later in the document using the \verb+\Cref+ command: \Cref{eq:mass-energy}.
